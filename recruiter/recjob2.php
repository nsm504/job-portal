...
<body>
	...
	<div class="container-fluid">
		<div class="row"><br><br>
			<div class="">
				<div class="tab-link1">								  
					<a class="active">Applied Candidates</a>
					<a class="tablinks" href="accepted_candidate.php?id=<?php echo $rid; ?>">Accepted Candidates</a>
					<a class="tablinks" href="rejected_candidate.php?id=<?php echo $rid; ?>">Rejected Candidates</a>
					<a class="tablinks" href="scheduled_interview.php?id=<?php echo $rid; ?>">Scheduled Interviews</a>
				</div>

				<div id="Details" class="tab-linkcontent1">
					<div class="row">					
								...
								<form action="#" method="POST">			
									<div class="form-group">
										...
										<select class="form-control" id="select_loc" name="loc">
											...
											<?php 
												$sql="SELECT DISTINCT user.location,user.user_first,user.user_last FROM applications INNER JOIN user ON applications.user_id=user.user_id WHERE(status='pending' AND user.location!='') ";
						...
						<div class="col-md-6">
							...
							?>
							<h3 align="center">Applicants for the post of <?php echo $title_row["job_title"]; ?></h3>
							<br>
							<table class="table" align="center" style="width:620px;">
								<thead>
									<tr id="trr">
								...
								<?php
									...
									{
										$sql="SELECT app_id,user.user_id,job_title,user_first,user_last,mobile,highest_qualification,course,specialization,percentage,interview_date FROM applications INNER JOIN user ON applications.user_id=user.user_id INNER JOIN joblist ON applications.job_id=joblist.job_id WHERE applications.recruiter_id='$SESSION' AND applications.job_id='$id' AND status='pending' ORDER BY percentage DESC LIMIT $page1,5 ";
										$result = mysqli_query($conn,$sql);
									}
								...
								?>
									...
									<tr id='trr'>
										...
										<td id='tdd'><a name='accept' href="../del_app.php?app=<?php echo $app; ?>" ><img src='../img/checked.png'></a>&nbsp;&nbsp;<a name='reject' href="../del_app.php?rej=<?php echo $app; ?>" ><img src='../img/error.png'></a>&nbsp;&nbsp;<a class='' href="../view_app.php?uid=<?php echo $uid; ?>"><img src='../img/eye1.png'></a></td>
									</tr>	
							...
							<?php 
						        $res=mysqli_query($conn,"SELECT * FROM applications WHERE recruiter_id='$SESSION' AND job_id='$id' AND status='pending' ORDER BY percentage DESC");
							...
							<nav align="center" aria-label="Page navigation example">
					        	<ul class="pagination justify-content-center">
							      	<?php
							          	if($page>=2)
							          	{
								            echo '<li class="page-item"><a class="page-link" href="?id='.$rid.'&pg=1">First Page</a></li>'; 
								            echo '<li class="page-item"><a class="page-link" href="?id='.$rid.'&pg='.($page-1).'">Previous</a></li>';
							          	}
							          	if($ceil<9)
							          	{
							          		for($i=1;$i<=$ceil;$i++)
								        ...
								        if($page<$ceil)
								        {
								            echo '<li class="page-item"><a class="page-link" href="?id='.$rid.'&pg='.($page+1).'">Next</a></li>'; 
								            echo '<li class="page-item"><a class="page-link" href="?id='.$rid.'&pg='.$ceil.'">Last Page</a></li>';
								        }   

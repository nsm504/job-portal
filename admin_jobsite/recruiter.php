	...
	<div align="center">
		<h3>REGISTERED RECRUITERS</h3>
			<div class="p-3">
				...
				<button id="rec" class="btn btn-sm excel btn-success">Download as Excel File</button>
			</div>
	</div>
		...
		<div class="table-responsive-sm">
			<table class="table table-bordered" style="width:1100px;">
				...
				<tr class="text-dark font-weight-normal">
					...
					<td><?php echo $row["recruiter_email"]; ?></td>
					<td class="status">
					<?php 
						...
						{
							echo '<span id="'.$row["recruiter_id"].'" class="confirmed btn btn-info btn-sm">Verification pending</span>';
						}
					...
					<td>
						<a href="recdetails.php?rid=<?php echo $row["recruiter_id"]; ?>"><span class=""><img src="../img/eye1.png"></span></a>
						&nbsp;
						<?php 
							if($row["account_status"]=='Deactivated')
							{
								echo '<span id="'.$row["recruiter_id"].'" class="restore"><img src="../img/restore.png"></span>';
							}
							else
							{
								echo '<span id="'.$row["recruiter_id"].'" class="deactivate"><img src="../img/delete.png"></span>';
							}
						?>
					</td>
				<?php

...
if(isset($_SESSION['recId']))
{
	...
	if($_FILES["file"]["name"] != '')
	{
		...
		{
			$query = "INSERT INTO recruiter_docs(recruiter_id,name,document_type) VALUES('$SESSION','$name','MSME registration')";
			mysqli_query($conn,$query);
		}
		else
		{
			$query = "UPDATE recruiter_docs SET name='$name' WHERE recruiter_id='$SESSION' AND document_type='MSME registration'";
			mysqli_query($conn,$query);
		}
